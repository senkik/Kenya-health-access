...
urlpatterns = [
    ...
    path('facilities/constituencies/', views.FacilityViewSet.as_view({'get': 'constituencies'}), name='facilities-constituencies'),
    path('facilities/towns/', views.FacilityViewSet.as_view({'get': 'towns'}), name='facilities-towns'),
