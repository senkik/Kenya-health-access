...
class Facility(models.Model):
    ...
    accepts_sha = models.BooleanField(default=False, verbose_name="Accepts Social Health Authority")
    sha_code = models.CharField(max_length=50, blank=True, verbose_name="SHA Code")
